 ...
 * Public — no auth required.
 */
export async function get_workflow_by(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    const hasFilter =
      query.title || query.role || query.category || query.toolStack;
    if (!hasFilter) {
      throw new BadRequestError(
        "At least one filter (title, role, category, toolStack) is required",
      );
    }
 ...
 * Public — no auth required.
 */
export async function get_workflow_by_id(
  req: Request,
  res: Response,
  next: NextFunction,
) {
 ...
 */
export async function update_workflow_likes(
  req: Request,
  res: Response,
  next: NextFunction,
) {
 ...
 */
export async function update_workflow_views(
  req: Request,
  res: Response,
  next: NextFunction,
) {
 ...
 * Protected — requires authentication.
 */
export async function update_workflow_clones(
  req: Request,
  res: Response,
  next: NextFunction,
) {
 ...
 * Protected — requires authentication.
 */
export async function create_workflow_comment(
  req: Request,
  res: Response,
  next: NextFunction,
) {
