...
function parseToolId(req: Request): number {
    ...
    if (!Number.isInteger(id) || id < 1) throw new BadRequestError("Invalid tool id");
    return id;
}
 ...
 * Public.
 */
export async function get_tools(req: Request, res: Response, next: NextFunction) {
    try {
 ...
 * Public.
 */
export async function get_tool(req: Request, res: Response, next: NextFunction) {
    try {
 ...
 */
export async function create_tool(req: Request, res: Response, next: NextFunction) {
    try {
 ...
 * Protected — admin only.
 */
export async function update_tool(req: Request, res: Response, next: NextFunction) {
    try {
 ...
 * Protected — admin only.
 */
export async function delete_tool(req: Request, res: Response, next: NextFunction) {
    try {
        const id = parseToolId(req);
 ...
 */
export async function add_review(req: Request, res: Response, next: NextFunction) {
    try {
 ...
 */
export async function update_review(req: Request, res: Response, next: NextFunction) {
    try {
        const userId = requireUserId(req);
        const id = parseToolId(req);
        const body = parseOrThrow(reviewSchema, req.body);
 ...
 * Protected — must be the review's author.
 */
export async function delete_review(req: Request, res: Response, next: NextFunction) {
    try {
        const userId = requireUserId(req);
        const id = parseToolId(req);
